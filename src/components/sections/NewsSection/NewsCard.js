...
export default function NewsCard({ item }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden w-full group hover:shadow-2xl transition-all duration-500" data-aos="fade-up">
      {/* IMAGE */}
      <div className="relative w-full h-56 sm:h-64 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 bg-[#1A2CA3] text-white px-5 py-3 text-center leading-tight rounded-tr-2xl shadow-lg">
          ...
          <div className="text-[10px] uppercase font-bold tracking-tighter">{month}</div>
        </div>
      </div>
