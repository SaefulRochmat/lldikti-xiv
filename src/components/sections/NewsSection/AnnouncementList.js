...
export default function AnnouncementList({ data }) {
  return (
    <div className="bg-[#1A2CA3] text-white rounded-2xl p-8 h-full shadow-xl" data-aos="fade-left">
      <div className="flex justify-between items-baseline mb-8">
        <h3 className="text-2xl font-bold tracking-tight border-b-2 border-yellow-400 pb-1">Pengumuman</h3>
        <Link
          href="/#"
